...
variable "org_it_cost_center" {
  description = "Organization-approved IT cost center."
  type        = string
  nullable    = false
}

variable "org_department" {
  description = "Organization-approved department."
  type        = string
  nullable    = false
}

variable "org_cmdb_calculated_app" {
  description = "Organization-approved CMDB calculated application."
  type        = string
  nullable    = false
}

variable "org_business_criticality" {
  description = "Organization-approved business criticality."
  type        = string
  nullable    = false
}

variable "org_environment" {
  description = "Organization-approved environment classification."
  type        = string
  nullable    = false
}

variable "org_data_classification" {
  description = "Organization-approved data classification."
  type        = string
  nullable    = false
}

variable "org_project_name" {
  description = "Organization-approved project name."
  type        = string
  nullable    = false
}

variable "org_managed_by" {
  description = "Organization-approved system or team managing the resources."
  type        = string
  nullable    = false
}

variable "org_additional_tags" {
  description = "Additional organization-approved tags."
  type        = map(string)
  default     = {}
  nullable    = false
}
